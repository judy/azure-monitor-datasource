            ...
            AppInsightsQueryBuilder = (function () {
                ...
                AppInsightsQueryBuilder.prototype.query = function (options) {
                    ...
                    var queries = lodash_1.default.filter(options.targets, function (item) {
                        ...
                        if (item.rawQuery) {
                            var querystringBuilder = new app_insights_rawquerystring_builder_1.default(item.rawQueryString);
                    ...
                    return this.$q.all(this.doQueries(queries)).then(function (results) {
